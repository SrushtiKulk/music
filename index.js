...
const db_connection = "mongodb+srv://srushtikulkarni:srushti1@cluster0.i3ajfir.mongodb.net/Music"
const port = 3000
...
//Insert
const documents = [
    { Songname: 'abc', Film: 'xyz', Music_director: 'pqr', singer: 'efg' },
  ...
  (async () => {
    try {
      await Songdetails.insertMany(documents);
